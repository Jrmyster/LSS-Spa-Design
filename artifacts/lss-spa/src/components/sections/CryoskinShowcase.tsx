...
const CARDS: ResultCard[] = [
  ...
  },
  {
    id: 2,
    title: "Cryo-Facial",
    subtitle: "Skin Tone Results",
    image: "images/cryofacial.png",
    imageAlt: "Before and after Cryo-Facial showing brighter complexion and reduced sun spots after 2 treatments",
    caption: "Before / After 2 Treatments",
    bullets: [
      "Brighten Complexion and Fade Sun Spots",
      "Diminish the Appearance of Fine Freckles",
      "Visible Skin Clarity in Just 2 Treatments",
    ],
