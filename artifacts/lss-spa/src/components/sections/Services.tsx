...
import { MicroneedlingSpotlight } from "@/components/sections/MicroneedlingSpotlight";
...
const FACIAL_SERVICES = [
  ...
  { name: "Microneedling", description: "Minimally invasive treatment using fine needles to create controlled micro-injuries — triggers your body's natural healing response to boost collagen & elastin, smoothing wrinkles, reducing acne scars & improving overall texture.", price: "$375", href: "#microneedling" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <li key={i} className="flex items-start justify-between gap-2 py-1.5 border-b border-border/30 last:border-0">
                      <div>
                        {"href" in item && item.href ? (
                          <a href={item.href as string} className="font-semibold text-foreground text-sm hover:text-secondary underline underline-offset-2 decoration-dotted transition-colors">
                            {item.name}
                          </a>
                        ) : (
        ...
        <div id="rf-treatments" className="mt-10 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0 bg-violet-50 border border-violet-200 rounded-full px-4 py-1.5">
              <Sparkles className="w-3.5 h-3.5 text-violet-500" />
              <span className="text-xs font-bold uppercase tracking-widest text-violet-600">Multi-Polar Radio Frequency Treatments</span>
            </div>
            <div className="flex-1 h-px bg-border/40" />
          </div>
        ...
        >
          <Card className="border-border/50 shadow-lg overflow-hidden">
            ...
            <CardContent className="pt-5">
              ...
              <ul className="space-y-3.5 mb-7">
                {[
                  { feature: "Skin Tightening & Lifting", detail: "Multi-polar RF uses gentle heat to stimulate fibroblasts, which increases collagen and elastin production, resulting in firmer, lifted skin." },
                  { feature: "Enhanced Collagen Production", detail: "Red LED light penetrates the dermis to enhance collagen and elastin production, boosting skin density." },
                  { feature: "Skin Rejuvenation & Tone", detail: "Improves overall appearance and enhances circulation for a revitalized, youthful appearance." },
                ].map((item) => (
                  <li key={item.feature} className="flex items-start gap-3">
              ...
              <div className="border-t border-border/40 pt-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
                  ...
                  <div className="rounded-xl border-2 border-sky-300 bg-sky-50/60 px-4 py-3.5 flex flex-col gap-0.5 shadow-sm relative overflow-hidden">
                    <span className="absolute top-2 right-2 text-[9px] font-extrabold uppercase tracking-wider bg-sky-500 text-white px-2 py-0.5 rounded-full">Best Value</span>
                  ...
                  <div className="rounded-xl border-2 border-violet-300 bg-violet-50/60 px-4 py-3.5 flex flex-col gap-0.5 shadow-sm relative overflow-hidden">
                    <span className="absolute top-2 right-2 text-[9px] font-extrabold uppercase tracking-wider bg-violet-500 text-white px-2 py-0.5 rounded-full">Max Savings</span>
        ...
        </div>{/* end #rf-treatments */}

        {/* Microneedling dedicated section */}
        <MicroneedlingSpotlight />
