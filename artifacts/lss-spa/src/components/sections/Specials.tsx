  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-b from-sky-100 via-sky-50 to-amber-50">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        <div className="absolute top-1/3 right-0 w-72 h-72 rounded-full bg-emerald-100/40 blur-2xl" />
        ...
        >
          ...
          <div className="p-6 sm:p-10">
            ...
            <motion.h2
              ...
              className="text-3xl sm:text-4xl font-display font-bold text-red-600 mb-1 leading-tight tracking-tight text-center"
            >
              🌻 MY SPA IS NOW OPEN!!! 🌻
            </motion.h2>
            ...
            <p className="font-display text-xl sm:text-2xl font-bold text-sky-700 mb-6 text-center">
              🌻 I Can't Wait To See You! 🌻
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
              ...
              <a href="tel:+18339245620" className="flex flex-col items-center gap-1 group">
