            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">123 Wellness Blvd<br/>Your City, ST 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@lssspaandwellness.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Tue - Fri: 10am - 6pm<br/>Sat: 9am - 3pm<br/>Sun & Mon: Closed</p>
                </div>
              </div>
            </div>

            <Button size="lg" className="w-full sm:w-auto rounded-full text-base px-8 h-14" asChild>
              <a href="#contact">Schedule Online Now</a>
            </Button>
          </motion.div>
