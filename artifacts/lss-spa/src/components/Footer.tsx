        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center md:items-start text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-white/60 text-sm max-w-xs">
              Specializing in corrective skincare and advanced body contouring therapies.
            </p>
          </div>

          <div className="flex flex-col gap-2 text-sm text-white/60">
            <h4 className="text-white font-semibold text-base mb-2 uppercase tracking-wider">Quick Links</h4>
          ...
          <div className="flex flex-col gap-2 text-sm text-white/60 md:text-right items-center md:items-end">
             <h4 className="text-white font-semibold text-base mb-2 uppercase tracking-wider">Follow Us</h4>
             ...
             <p className="mt-2 text-xs">
              © {new Date().getFullYear()} LSS Spa and Wellness LLC.<br/>All Rights Reserved.
             </p>
          </div>
